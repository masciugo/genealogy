...
shared_context "unreleted people exist with dates" do
  ...
  before do
    ...
    alison.update_attributes(birth_date: Date.new(1920,8,10))
    ...
    emily.update_attributes(birth_date: Date.new(1903,1,6))
    irene.update_attributes(birth_date: Date.new(1847,3,10))
    jack.update_attributes(birth_date: Date.new(1915,10,1))
    john.update_attributes(birth_date: Date.new(1948,12,4))
    julian.update_attributes(birth_date: Date.new(2000,2,3))
    larry.update_attributes(birth_date: Date.new(1870,9,3), death_date: Date.new(1900,6,4))
    ...
    maggie.update_attributes(birth_date: Date.new(1952,4,17))
    ...
    mary.update_attributes(birth_date: Date.new(2011,4,10))
    mia.update_attributes(birth_date: Date.new(1985,1,10))
    michelle.update_attributes(birth_date: Date.new(1980,7,6))
    naomi.update_attributes(birth_date: Date.new(1950,11,6))
    ned.update_attributes(birth_date: Date.new(1930,5,1))
    ...
    ruben.update_attributes(birth_date: Date.new(1996,2,3))
    ...
    terry.update_attributes(birth_date: Date.new(1940,10,16))
    titty.update_attributes(birth_date: nil, death_date: Date.new(2010,8,6))
    tommy.update_attributes(birth_date: Date.new(1895,12,9))
  end
end
